...
Conversion follows [rjson](https://cran.r-project.org/web/packages/rjson/index.html) conventions (by actually using rjson for that purpose), i.e. unnamed lists and vectors turn into arrays, named lists into objects, and 1-element vectors into scalars.
...
This concludes this brief tutorial; for more information, it is best to consult the [RethinkDB documentation](https://rethinkdb.com/docs/) and the [rethinker manual](https://cran.r-project.org/web/packages/rethinker/rethinker.pdf).
